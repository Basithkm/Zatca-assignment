...
Route::get('invoice/download/{id}', 'App\Http\Controllers\InvoiceController@invoice_download');
Route::get('download/invoice', 'App\Http\Controllers\InvoiceController@all_data_download');
