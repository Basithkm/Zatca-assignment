...
<!DOCTYPE html>
    ...
    <div class="py-12">
     ...
     <a href="{{URL('invoice/create')}}" class="btn btn-primary">Add New</a>
     <div style="text-align: right;">
        <a href="{{URL('download/invoice')}}" class="btn btn-primary">Download Invoice</a>
        </div>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><a href="{{URL('invoice/download/'.$master->id)}}" class="btn btn-dark">download</a></td>
    </tr>
    @endforeach
  </tbody>
</table>
